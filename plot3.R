...
with(table_req, plot(range(table_req$newdate), range(table_req$Sub_metering_1, table_req$Sub_metering_2, table_req$Sub_metering_3), type = "n", xlab="", ylab="Energy sub metering",))
